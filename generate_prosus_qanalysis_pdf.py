#!/usr/bin/env python3
"""Generate a PDF from the Prosus Q-analysis markdown report."""

import re
from fpdf import FPDF

INPUT = "Prosus-qanalysis.md"
OUTPUT = "docs/pdfs/Prosus-qanalysis.pdf"
...
class MarkdownPDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 10, "Prosus N.V. (PRX) - Quartr-Enhanced Investment Analysis", align="C")
            self.set_text_color(0, 0, 0)
            self.ln(12)
...
def parse_and_render(md_path, output_path):
    ...
    pdf.title_page(
        ...
        [
            ...
            "",
            "Date: 31 March 2026",
            "Market Cap: ~$104B USD | Euronext Amsterdam",
            "CEO: Fabricio Bloisi | Parent: Naspers",
            "",
