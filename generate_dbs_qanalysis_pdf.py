#!/usr/bin/env python3
"""Generate a PDF from the DBS Group Quartr-enhanced analysis."""

import re
from fpdf import FPDF

INPUT = "DBS Group-qanalysis.md"
OUTPUT = "docs/pdfs/DBS Group-qanalysis.pdf"
...
class MarkdownPDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 10, "DBS Group - Quartr-Enhanced Investment Analysis", align="C")
            self.set_text_color(0, 0, 0)
            self.ln(12)
