#!/usr/bin/env python3
"""Generate a PDF from the Credicorp Quartr-enhanced analysis markdown."""

import re
from fpdf import FPDF

INPUT = "Credicorp-qanalysis.md"
OUTPUT = "docs/pdfs/Credicorp-qanalysis.pdf"
...
class MarkdownPDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 10, "Credicorp (BAP) - Quartr-Enhanced Investment Analysis", align="C")
            self.set_text_color(0, 0, 0)
            self.ln(12)
...
def parse_and_render(md_path, output_path):
    ...
    pdf.title_page(
        ...
        [
            ...
            "",
            "Date: 31 March 2026",
            "Market Cap: ~$25.6B USD | NYSE: BAP",
            "GICS: Diversified Banks | Peru",
        ],
    )
