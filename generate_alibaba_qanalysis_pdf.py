#!/usr/bin/env python3
"""Generate PDF from Alibaba Group Quartr-enhanced analysis."""

import re
import sys
from fpdf import FPDF

INPUT = "Alibaba-qanalysis.md"
OUTPUT = "docs/pdfs/Alibaba-qanalysis.pdf"
...
class MarkdownPDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 10, "Alibaba Group - Quartr-Enhanced Analysis", align="C")
            self.set_text_color(0, 0, 0)
            self.ln(12)
...
def parse_and_render(md_path, output_path):
    ...
    pdf.title_page(
        ...
        [
            ...
            "Date: 5 April 2026",
            "Market Cap: $274B USD",
            "Sector: Broadline Retail | Headquarters: Hangzhou, China",
        ],
    )
